...
// See VTC_Maker.coffee in VTC Maker.app/Contents/BV Scripts for commented code
  
  // -------- PASTE TEXT FILE PATH BETWEEN QUOTES -------- 
  // SHOULD LOOK LIKE: filename = String("Users/aUser/Desktop/Subject1/Subject1.txt")
  filename = String("PASTE PATH HERE");

  var filename, projfls, readTextFile;

  readTextFile = function(name) {
    var FA_path, IA_path, VMR, VMR_path, filecounter, filename, filenamesfile, fmr_files, fmr_regex, i, make_VTC, match, name_regex, newmatch, nroffiles, textstr, vtc, vtc_names, x_end, x_start, xcoords_regex, y_end, y_start, ycoords_regex, z_end, z_start, zcoords_regex;
    fmr_files = [];
    vtc_names = [];
    x_start = [];
    x_end = [];
